...
3. Run `Navigation.ipynb` notebook for training and seeing the training result  

### Instructions

Follow the instructions in `Navigation.ipynb` to get started with training your own agent!  
Further information regarding to the implementation can be found Report.md [click here](./Report.md)   
