...
3. Clone this repository and place the downloaded file (step 2) in the `p1_navigation/` folder, and unzip (or decompress) the file.   

4. Start conda environment (step 1)   

5. Run `Navigation.ipynb` notebook for training and seeing the training result  
